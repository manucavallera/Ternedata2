...
export class AuthService {
  ...
  async register(registerAuthDto: RegisterAuthDto) {
    ...
    console.log(
      `🎟️ [SERVICE] Token recibido: ${invitationToken ? 'SÍ' : 'NO'}`,
    );
    ...
    if (invitationToken) {
      try {
        ...
        estadoInicial = 'activo'; // ✅ Token OK = Usuario Activo
        console.log(
        ...
        // throw new HttpException('Token inválido', HttpStatus.BAD_REQUEST); // Descomentar si quieres ser estricto
      }
    }
