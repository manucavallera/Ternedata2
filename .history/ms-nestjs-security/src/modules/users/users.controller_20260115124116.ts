...
export class UsersController {
  ...
  // 👇 MODIFICADO: Ya no usa @Roles(UserRole.ADMIN) estricto para permitir lógica dinámica
  @Get()
  @ApiOperation({ summary: 'Obtener usuarios (Filtrado según quién lo pide)' })
  async findAll(@Request() req) {
    // Validamos que venga el usuario en el token
    if (!req.user) {
    ...
    // Pasamos el usuario al servicio para que filtre
