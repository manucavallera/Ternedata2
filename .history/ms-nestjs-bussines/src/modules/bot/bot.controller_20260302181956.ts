      ...
      switch (accion) {
        ...
        case 'crear_ternero': {
          ...
          const data = {
            ...
            fecha_nacimiento: hoy, // Siempre fecha de hoy (Gemini inventa fechas)
            observaciones:
        ...
        case 'crear_evento': {
          ...
          const data = {
            fecha_evento: hoy, // Siempre fecha de hoy
        ...
        case 'crear_tratamiento': {
          ...
          const data = {
            ...
            fecha_tratamiento: hoy, // Siempre fecha de hoy
            id_establecimiento: idEstablecimiento,
            ternero: terneroObj,
          };
        ...
        case 'crear_diarrea': {
          ...
          const data = {
            fecha_diarrea_ternero: hoy, // Siempre fecha de hoy
