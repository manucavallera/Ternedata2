...
export const useBussinesMicroservicio = () => {
  ...
  const obtenerRodeosHook = async (queryParams = "") => {
    try {
      ...
      console.error("❌ Error en obtenerRodeosHook:", error.response?.status);
  ...
  const crearRodeoHook = async (dataRodeo) => {
    try {
      ...
      console.error("❌ Error en crearRodeoHook:", error.response?.status);
  ...
  const actualizarRodeoHook = async (id, dataRodeo) => {
    try {
      ...
      console.error("❌ Error en actualizarRodeoHook:", error.response?.status);
  ...
  const toggleEstadoRodeoHook = async (id) => {
    try {
      ...
      console.error(
        "❌ Error en toggleEstadoRodeoHook:",
        error.response?.status
      );
  ...
  const obtenerEstadisticasRodeoHook = async (id, queryParams = "") => {
    try {
      ...
      // ✅ Proteger acceso a error.response
      console.error(
  ...
  const asignarTernerosRodeoHook = async (idRodeo, data) => {
    try {
      const {
        ...
        statusText,
        request,
      } = await businessApi.post(`/rodeos/${idRodeo}/asignar-terneros`, data);
      return {
        data: responseData,
        config,
        headers,
      ...
      console.error(
        "❌ Error en asignarTernerosRodeoHook:",
        error?.response?.status
      );
  ...
  const desasignarTernerosRodeoHook = async (idRodeo, data) => {
    try {
      const {
        ...
        `/rodeos/${idRodeo}/desasignar-terneros`,
        data
      );
      return {
        data: responseData,
      ...
      console.error(
        "❌ Error en desasignarTernerosRodeoHook:",
        error?.response?.status
      );
