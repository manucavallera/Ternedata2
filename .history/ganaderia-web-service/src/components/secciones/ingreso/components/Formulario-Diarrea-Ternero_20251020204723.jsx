...
const FormularioDiarreaTernero = ({ setStep }) => {
  ...
  useEffect(() => {
    const cargarEstablecimientos = async () => {
      if (userPayload?.rol === "admin" && !hasLoadedEstablecimientos.current) {
        ...
        try {
          console.log("🔍 Cargando establecimientos para Admin...");
          ...
          if (response?.data && Array.isArray(response.data)) {
            ...
            // Si hay establecimiento seleccionado en Redux, usarlo
            ...
            console.warn(
              "⚠️ No se recibieron establecimientos o formato incorrecto"
            );
            setEstablecimientos([]);
          }
        } catch (error) {
  ...
  }, [userPayload, establecimientoActual]); // ✅ SIN obtenerEstablecimientosHook
