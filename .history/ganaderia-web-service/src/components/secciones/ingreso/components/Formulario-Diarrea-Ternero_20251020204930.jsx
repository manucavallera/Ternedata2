...
const FormularioDiarreaTernero = ({ setStep }) => {
  ...
  console.log("🧪 DEBUG - userPayload completo:", userPayload);
  console.log("🧪 DEBUG - Rol del usuario:", userPayload?.rol);
  console.log("🧪 DEBUG - ¿Es Admin?:", userPayload?.rol === "admin");
  console.log("🧪 DEBUG - Establecimiento actual:", establecimientoActual);
        ...
        try {
          ...
          if (response?.data) {
            ...
            const establecimientosActivos = response.data.filter((est) => {
              console.log("   - Revisando:", est.nombre, "activo:", est.activo);
        ...
        <div className='mb-6 bg-gray-50 p-4 rounded-lg'>
          ...
          <SeleccionarTernero
            ...
            establecimientoFiltro={
              userPayload?.rol === "admin" ? establecimientoSeleccionado : null
            }
          />
