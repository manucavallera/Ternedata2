  ...
  const cargarRodeos = async () => {
    try {
      ...
      if (response?.status === 200) {
        ...
        const rodeosActivos = response.data.filter(r => r.estado === 'activo');
        ...
        <form onSubmit={onSubmit} className='space-y-4'>
          ...
          <div className='border-t pt-4'>
            ...
            {mostrarCalostrado && (
              <div className='space-y-4 bg-blue-50 p-4 rounded-lg'>
                ...
                <div>
                  <label htmlFor='metodo_calostrado' className='block text-sm font-medium text-gray-700 mb-1'>
                ...
                <div>
                  <label htmlFor='litros_calostrado' className='block text-sm font-medium text-gray-700 mb-1'>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full p-3 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 ${
                      errors.litros_calostrado ? "border-red-500" : "border-gray-300"
                    }`}
                    placeholder='Ej: 2.5'
                    min='0.1'
                  />
                  {errors.litros_calostrado && (
                    <span className='text-red-500 text-sm'>{errors.litros_calostrado}</span>
                  )}
                </div>

                <div>
                  <label htmlFor='grado_brix' className='block text-sm font-medium text-gray-700 mb-1'>
                  ...
                  />
                  {errors.grado_brix && (
                    <span className='text-red-500 text-sm'>{errors.grado_brix}</span>
                  )}
                ...
                <div>
                  <label htmlFor='fecha_hora_calostrado' className='block text-sm font-medium text-gray-700 mb-1'>
                ...
                <div>
                  <label htmlFor='observaciones_calostrado' className='block text-sm font-medium text-gray-700 mb-1'>
          ...
          <div className='bg-blue-50 border border-blue-200 rounded-lg p-3'>
            ...
            <ul className='text-sm text-blue-700 space-y-1'>
              ...
              <li>• La asignación a rodeo, calostrado y grado Brix son opcionales</li>
            </ul>
          </div>
