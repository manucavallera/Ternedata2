...
const AdminPanel = () => {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 p-6 mt-16'>
      ...
      {activeTab === "equipo" && (
        <div className='space-y-6'>
          {/* ⚠️ NOTA: Aquí asumimos que userPayload tiene el ID. 
         Si usas el Selector de la navbar, deberías traer ese ID desde Redux */}
          {userPayload?.id_establecimiento ? (
            <TeamManager establecimientoId={userPayload.id_establecimiento} />
          ) : (
