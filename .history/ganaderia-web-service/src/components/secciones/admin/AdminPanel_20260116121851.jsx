...
const AdminPanel = () => {
  ...
  const [usuarioSeguro, setUsuarioSeguro] = useState(userPayload);
  ...
  useEffect(() => {
    ...
    // Si no tiene ID (es null o un usuario "dummy"), vamos al servidor
    const recuperarUsuario = async () => {
      const token = getToken();
      if (!token) return;

      try {
        console.log("🔄 Recuperando sesión del servidor..."); // Log para depurar
