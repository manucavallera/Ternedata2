...
const API_URL = "http://localhost:3000/api"; // O la URL de tu backend
const getToken = () => localStorage.getItem("token"); // Helper para sacar el token
...
const AdminPanel = () => {
  ...
  const handleSaveBusinessRules = async (e) => {
    ...
    try {
      ...
      // Llamada al microservicio de Business
      // Asegúrate de tener este endpoint en tu backend: PATCH /establecimientos/:id
      await axios.patch(
        `${API_URL}/business/establecimientos/${idEstablecimiento}`,
        payload,
        { headers: { Authorization: `Bearer ${token}` } },
      );
