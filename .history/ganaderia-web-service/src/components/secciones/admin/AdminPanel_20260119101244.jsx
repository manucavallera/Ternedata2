...
const AdminPanel = () => {
  ...
  useEffect(() => {
    if (establecimientoActual && establecimientoActual.configuracion) {
      console.log(
        "📥 Cargando configuración guardada:",
        establecimientoActual.configuracion,
      );

      setConfigData((prev) => ({
        ...prev, // Mantenemos lo que ya estaba
        umbralMortalidad:
          establecimientoActual.configuracion.umbral_mortalidad || 5,
        umbralMorbilidad:
          establecimientoActual.configuracion.umbral_morbilidad || 10,
      }));
    }
