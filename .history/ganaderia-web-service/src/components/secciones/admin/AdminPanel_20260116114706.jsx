...
const AdminPanel = () => {
  ...
  useEffect(() => {
    if (activeTab === "configuracion" && userPayload) {
      setConfigData((prev) => ({
        ...prev,
        name: userPayload.name || "",
        email: userPayload.email || "", // El email suele ser solo lectura
    ...
    <div className='min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 p-6 mt-16'>
      ...
      {activeTab === "configuracion" && (
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
          {/* COLUMNA 1: PERFIL DE USUARIO (MS-SECURITY) */}
          <div className='bg-white rounded-lg shadow-md p-6'>
            ...
            <form onSubmit={handleUpdateProfile} className='space-y-4'>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setConfigData({ ...configData, telefono: e.target.value })
                  }
                  className='w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none'
                  placeholder='+54...'
                />
          ...
          {/* COLUMNA 2: REGLAS DE NEGOCIO (MS-BUSINESS) */}
          <div className='bg-white rounded-lg shadow-md p-6'>
            <div className='flex items-center gap-2 mb-6 border-b pb-4'>
              ...
              <div>
                ...
                <p className='text-sm text-gray-500'>
                  Define cuándo el sistema debe avisarte
                </p>
              </div>
            </div>
            ...
            <form onSubmit={handleSaveBusinessRules} className='space-y-6'>
              <div className='bg-red-50 p-4 rounded-lg border border-red-100'>
                <label className='flex justify-between text-sm font-medium text-gray-700 mb-2'>
                  <span>💀 Umbral de Mortalidad Crítica</span>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setConfigData({
                      ...configData,
                      umbralMortalidad: e.target.value,
                    })
                  }
                  className='w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-red-600'
                />
                <p className='text-xs text-gray-500 mt-2'>
                  Si la mortalidad supera el{" "}
                  <strong>{configData.umbralMortalidad}%</strong>, el dashboard
                  mostrará una alerta roja 🚨.
                </p>
              </div>

              <div className='bg-yellow-50 p-4 rounded-lg border border-yellow-100'>
                <label className='flex justify-between text-sm font-medium text-gray-700 mb-2'>
                  <span>🤒 Umbral de Morbilidad (Enfermedad)</span>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setConfigData({
                      ...configData,
                      umbralMorbilidad: e.target.value,
                    })
                  }
                  className='w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-yellow-600'
                />
                <p className='text-xs text-gray-500 mt-2'>
                  Alerta amarilla si más del{" "}
                  <strong>{configData.umbralMorbilidad}%</strong> del rodeo
                  enferma.
                </p>
              </div>
