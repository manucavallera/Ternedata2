...
const Registercomponent = () => {
    ...
    const {sessionRegister} = useRouterSession();
  ...
  <div className='h-[calc(100vh-7rem)] flex justify-center items-center'>
            ...
            <input type='text' placeholder='name' {...(register("username",{
              ...
              maxLength: 20,
              minLength: 2,
            }))} className='shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline mb-2'></input>
            {
            ...
            {
              errors.passwrod && <p className='text-red-500 text-xs'>{errors.passwrod.message}</p>
            }
            <label htmlFor='password' className='block text-gray-700 text-sm font-bold mb-2'>
                  Confirm Password
            </label>
