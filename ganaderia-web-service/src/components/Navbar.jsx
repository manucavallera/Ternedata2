  ...
  return (
    <nav className='bg-green-400 text-white px-3 sm:px-6 md:px-12 lg:px-24 py-3 relative'>
      <div className='flex justify-between items-center'>
        ...
        {/* Menú derecha - Desktop (autenticado) / Siempre visible (no autenticado) */}
        <ul className={`${status === "checking" || (status !== "authenticated" && statusSession === false) ? "flex" : "hidden lg:flex"} gap-x-2 xl:gap-x-4 items-center`}>
          {status === "checking" ||
          (status !== "authenticated" && statusSession === false) ? (
            <>
              <li>
              ...
              <li>
                <Link href='/auth/login' className='flex items-center gap-1 bg-white text-green-700 font-semibold text-sm px-3 py-1.5 rounded-lg hover:bg-green-50'>
                  Ingresar
                </Link>
              </li>
              <li>
                <Link href='/auth/register' className='flex items-center gap-1 bg-green-600 text-white font-semibold text-sm px-3 py-1.5 rounded-lg hover:bg-green-700'>
                  Registrarse
                </Link>
              </li>
            </>
