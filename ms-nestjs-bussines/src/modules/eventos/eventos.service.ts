  ...
  async create(
    ...
    try {
      ...
      const eventoCreated = this.eventoRepository.create({
        fecha_evento: new Date(createEventoDto.fecha_evento + 'T12:00:00'), // ← Agregar hora al mediodía
    ...
    try {
      ...
      for (const eventoDto of createEventosData.eventos) {
        ...
        const eventoCreado = this.eventoRepository.create({
          fecha_evento: new Date(eventoDto.fecha_evento + 'T12:00:00'), // ← Agregar hora al mediodía
